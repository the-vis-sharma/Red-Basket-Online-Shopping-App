...
public class CheckoutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvAddNewAddress = view.findViewById(R.id.tv_checkout_add_new_address);
        tvPlaceOrder = view.findViewById(R.id.tv_checkout_place_order);
        recyclerView = view.findViewById(R.id.rv_checkout_choose_address);
    ...
    private void fetchSavedAddress() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String result) {
                        ...
                        try {
                            ...
                            if(response.getBoolean("success")) {
                                ...
                                Snackbar.make(tvAddNewAddress, response.getString("message"), Snackbar.LENGTH_LONG ).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Snackbar.make(tvAddNewAddress, "Something Went Wrong.", Snackbar.LENGTH_LONG).show();
            }
        }) {
            @Override
    ...
    private void placeOrder() {
        ...
        //this is the url where you want to send the request
        //TODO: replace with your own url to send request, as I am using my own localhost for this tutorial
        String url = getString(R.string.host_url) + "place_order.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String result) {
                        ...
                        try {
                            ...
                            if(response.getBoolean("success")) {
                                FragmentManager manager = getFragmentManager();
                                OrderPlacedFragment opf = new OrderPlacedFragment();
                                manager.beginTransaction().replace(R.id.RelativeLayoutHome, opf, opf.getTag()).addToBackStack(null).commit();
                            } else {
                                Snackbar.make(tvAddNewAddress, response.getString("message"), Snackbar.LENGTH_LONG ).show();
                            }
                        } catch (JSONException e) {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("user_id", pref.getString("user_id", "null"));
                try {
                    params.put("a_id", saveAddressList.getJSONObject(selectedPosition).getString("a_id"));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                return params;
